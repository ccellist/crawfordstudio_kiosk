...
class OrderServiceTest extends PHPUnit_Framework_Testcase{
    ...
    public function testGetOrderById(){
        ...
        $this->assertEquals("test1.jpg", $order->orderItems[0]->photo->photoName);
    ...
    public function testGetOrdersByCustomerEmail(){
        ...
        $customerOrders = $this->orderService->getOrdersByCustomerEmail("test@email.com");
        $this->assertEquals(count(array($testOrder, $testOrder2)), count($customerOrders));   
        $this->assertEquals("test1.jpg", $customerOrders[0]->orderItems[0]->photo->photoName);   
        $this->assertEquals("test2.jpg", $customerOrders[1]->orderItems[0]->photo->photoName);   
        $this->assertEquals("test3.jpg", $customerOrders[1]->orderItems[1]->photo->photoName);
    }
    ...
    public function testGetOrdersFromCustomerWithNoOrders(){
        $customerOrders = $this->orderService->getOrdersByCustomerEmail("test4@email.com");
...
//        $this->assertEquals("test1.jpg", $testOrder->orderItems[0]->photo->photoName);
//        $this->assertEquals("test3.jpg", $testOrder->orderItems[2]->photo->photoName);
//    }
    ...
    public function testPrepOrderForBurning(){
        ...
        $this->assertEquals(PHOTO_DESTINATION . "\\test@email.com\\$today\\1", $photosToCopy[0]->destPath);
        $this->assertEquals("test1.jpg", $photosToCopy[0]->photoName);
